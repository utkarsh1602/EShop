...
def Home(request):
	...
	hash_object = hashlib.sha256(str(uuid.uuid4()).encode('utf-8'))
	...
	action =PAYU_BASE_URL #"https://test.payu.in/_payment"
	if(posted.get("key")!=None and posted.get("txnid")!=None and posted.get("productinfo")!=None and posted.get("firstname")!=None and posted.get("email")!=None):
		return render(request, 'current_datetime.html', {"posted":posted,"hashh":hashh,"MERCHANT_KEY":MERCHANT_KEY,"txnid":txnid,"hash_string":hash_string,"action":action})
	else:
